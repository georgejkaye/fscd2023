...
Intuitively, partial monogamy means that each vertex either exactly one `in' and
`out' connection, be it to an edge or to an interface, or none at all.
