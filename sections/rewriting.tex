...
\) for the map on rewrite systems with pointwise action \(
    (
        \iltikzfig{strings/category/f}[l][white][i][j],
        \iltikzfig{strings/category/f}[r][white][i][j]
    )
    \mapsto
    (
        \foldinterfaces[\tracedtosymandfrob[\iltikzfig{strings/category/f}[l][white]]{\Sigma}],
        \foldinterfaces[\tracedtosymandfrob[\iltikzfig{strings/category/f}[r][white]]{\Sigma}]
    ).
\)
