...
categories.
This yields a \emph{choice} of traced boundary complement,
...
In the latter, the image of the matching must be \emph{convex}: any path between
vertices must also be in the image.
